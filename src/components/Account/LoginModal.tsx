  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-label="Sign in to SwarmTerm"
        onMouseDown={(e) => e.stopPropagation()}
        className="relative w-80 rounded-xl border border-border bg-card p-6 shadow-2xl"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="mb-5 text-center">
          <h2 className="text-base font-semibold text-foreground">Sign in to SwarmTerm</h2>
